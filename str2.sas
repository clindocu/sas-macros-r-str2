...
%gather2(db00_OBS1, _VARIABLE_tmp_, _Value_tmp_, , db00_TINY1a, ValFormat=$400., WithFormats=Y, SASFormats=Y);
...
%gather2(&DBIN, _VARIABLE_tmp_, _Value_tmp_, , db00_TINY_ALL, ValFormat=$400., WithFormats=Y, SASFormats=Y);
